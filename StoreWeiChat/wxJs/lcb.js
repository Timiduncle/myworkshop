...
define("textUILoadingHtml", [], function() {
	...
	}), define("textimagesWxhow", [], function() {
		return function(obj) {
			{
				var __t, __p = "";
				Array.prototype.join
	...
	}), define("controller/shop/picture", ["textshopPictureHtml", "PageView", "session", "UISlideshow2", "prefix", "textimagesWxhow"], function(t, e, i, n, a, r) {
		var o = e.extend({
			events: {
			...
			onCreate: function() {
				...
				var e;
				e = this.detail ? this.detail.storeimagesWx || this.detail.storeOriginalimagesWx : [];
				var n = this.template(t, {
					pics: e
				});
				this.$el.html(n)
			...
			onShow: function() {
				var t = (this.detail.storeOriginalimagesWx || this.detail.storeimagesWx, document.querySelector("body"));
			...
			imgShow: function(t) {
				var e = 0,
					...
					a = this.detail.storeOriginalimagesWx || this.detail.storeimagesWx,
					o = this.template(r, {
						picsOriginal: a
					});
