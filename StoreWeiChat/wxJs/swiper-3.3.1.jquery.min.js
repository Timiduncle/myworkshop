...
!function () {
    ...
    var a, t = function (e, s) {
        ...
        if (y.params = s, y.originalParams = f, y.classNames = [], "undefined" != typeof a && "undefined" != typeof Dom7 && (a = Dom7), ("undefined" != typeof a || (a = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (y.$ = a, y.currentBreakpoint = void 0, y.getActiveBreakpoint = function () {
            ...
            }, y.params.grabCursor && (y.container[0].style.cursor = "move", y.container[0].style.cursor = "-webkit-grab", y.container[0].style.cursor = "-moz-grab", y.container[0].style.cursor = "grab"), y.imagesWxToLoad = [], y.imagesWxLoaded = 0, y.loadImage = function (e, a, t, s, r) {
                function i() {
                    r && r()
                }
            ...
            }, y.preloadimagesWx = function () {
                function e() {
                    "undefined" != typeof y && null !== y && (void 0 !== y.imagesWxLoaded && y.imagesWxLoaded++, y.imagesWxLoaded === y.imagesWxToLoad.length && (y.params.updateOnimagesWxReady && y.update(), y.emit("onimagesWxReady", y)))
                }

                y.imagesWxToLoad = y.container.find("img");
                for (var a = 0; a < y.imagesWxToLoad.length; a++)y.loadImage(y.imagesWxToLoad[a], y.imagesWxToLoad[a].currentSrc || y.imagesWxToLoad[a].getAttribute("src"), y.imagesWxToLoad[a].srcset || y.imagesWxToLoad[a].getAttribute("srcset"), !0, e)
